...
namespace Toolbox.Editor.Drawers
{
    public abstract class MaterialConditionalDrawer : BaseMaterialPropertyDrawer
    {
        ...
        protected virtual bool HasToggle(MaterialProperty prop)
        {
            ...
            result = toggle != null && (toggle.propertyType == ShaderPropertyType.Float || toggle.propertyType == ShaderPropertyType.Range);
#else
            result = toggle != null && (toggle.type == MaterialProperty.PropType.Float || toggle.type == MaterialProperty.PropType.Range);
#endif
            return result;
        }
