...
namespace Genies.UI.Extensions
{
	/// <summary>
...
#endif
	{
		...
		[FormerlySerializedAs("invertOrder")] public bool InvertOrder = false;
		private float _layoutHeight;
		private float _layoutWidth;

		[FormerlySerializedAs("m_StartAxis")] [SerializeField] protected Axis _startAxis = Axis.Horizontal;
