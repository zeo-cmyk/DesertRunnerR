...
- (void)create:(NSDictionary *)data {
    ...
    if (isMultiline) {
        ...
        textView.autocapitalizationType = autoCorrection ? UITextAutocapitalizationTypeSentences : UITextAutocapitalizationTypeNone;
        textView.spellCheckingType = autoCorrection ? UITextSpellCheckingTypeDefault : UITextSpellCheckingTypeNo;
        ...
        textField.autocapitalizationType = autoCorrection ? UITextAutocapitalizationTypeSentences : UITextAutocapitalizationTypeNone;
        textField.spellCheckingType = autoCorrection ? UITextSpellCheckingTypeDefault : UITextSpellCheckingTypeNo;
