...
namespace UMA
{
...
#endif
	{
        ...
        private RaceRecipes raceRecipes = new RaceRecipes();
...
#region Fields
        ...
        private static UMAAssetIndexer theIndexer = null;
        ...
        public static UMAAssetIndexer Instance
        {
            get
            {
                if (theIndexer == null)
                {
                    ...
                    if (!theIndexer)
                    {
                        theIndexer = CreateInstance<UMAAssetIndexer>();
                    }
...
#region Add Remove Assets
        ...
        public bool EvilAddAsset(System.Type type, UnityEngine.Object o)
        {
            ...
            ai._Path = AssetDatabase.GetAssetPath(o);
            ...
            for (int i = 0; i < SerializedItems.Count; i++)
            {
                ...
                if (!ai.IsAssetBundle)
                {
                    ...
                    if (obj != null)
                    {
                        ...
                        ai._Path = AssetDatabase.GetAssetPath(obj);
