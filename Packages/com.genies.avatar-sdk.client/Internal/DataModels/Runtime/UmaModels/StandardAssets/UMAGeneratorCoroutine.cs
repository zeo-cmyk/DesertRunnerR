...
namespace UMA
{
...
#endif
	{
        ...
        private MaterialDefinitionComparer comparer = new MaterialDefinitionComparer();
        private List<UMAData.GeneratedMaterial> generatedMaterials;
        private List<UMARendererAsset> uniqueRenderers = new List<UMARendererAsset>();
        private List<UMAData.GeneratedMaterial> atlassedMaterials = new List<UMAData.GeneratedMaterial>(20);
