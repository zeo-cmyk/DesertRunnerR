...
namespace UMA.AssetBundles
{
...
#endif
    {
        ...
        private static System.Collections.Generic.List<string> _requestLog = new System.Collections.Generic.List<string>();
        ...
        private void OnGetContext(IAsyncResult async)
        {
