...
namespace UMA.AssetBundles
{
...
#endif
	{
		...
		public static AssetBundleLoadingIndicator FindInstance()
		{
			if (_instance == null)
			{
				AssetBundleLoadingIndicator[] assetBundleLoadingIndicator = FindObjectsByType(typeof(AssetBundleLoadingIndicator), FindObjectsSortMode.None) as AssetBundleLoadingIndicator[];
