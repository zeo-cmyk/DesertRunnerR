...
using UMA.PoseTools;
using UmaModels.DynamicCharacterSystem; //so we can set the expression set based on the race
#if UMA_ADDRESSABLES
...
namespace UMA.CharacterSystem
{
...
#endif
    {
		...
		public static void CreateDynamicCharacterAvatarMenuItem()
		{
			...
			da.umaGenerator = Component.FindAnyObjectByType<UMAGeneratorBase>();
