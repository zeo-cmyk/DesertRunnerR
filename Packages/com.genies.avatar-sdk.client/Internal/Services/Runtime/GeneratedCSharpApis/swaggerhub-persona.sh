...
mv tmp/src/Genies.Persona/Api/* Genies.Persona/Api/
mv tmp/src/Genies.Persona/Client/* Genies.Persona/Client/
mv tmp/src/Genies.Persona/Model/* Genies.Persona/Model/
