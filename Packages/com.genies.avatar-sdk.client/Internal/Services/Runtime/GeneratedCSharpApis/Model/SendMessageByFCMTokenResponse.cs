...
{
    /// <summary>
    /// SendMessageByFCMTokenResponse
    /// </summary>
    [DataContract]
        public partial class SendMessageByFCMTokenResponse :  IEquatable<SendMessageByFCMTokenResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SendMessageByFCMTokenResponse" /> class.
        /// </summary>
        ...
        public SendMessageByFCMTokenResponse(int? successCount = default(int?), int? errorCount = default(int?), List<string> successMessages = default(List<string>), List<string> errorMessages = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SendMessageByFCMTokenResponse {\n");
        ...
        {
            return this.Equals(input as SendMessageByFCMTokenResponse);
        }

        /// <summary>
        /// Returns true if SendMessageByFCMTokenResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SendMessageByFCMTokenResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SendMessageByFCMTokenResponse input)
        {
            if (input == null)
                return false;
